...
//
#define X_DIAG_PIN                          -1  // Driver0 diag signal is connected to X-
#define Y_DIAG_PIN                          -1  // Driver1 diag signal is connected to Y-
...
// ============================
// Disable all DIAG pins (센서리스 홈 OFF)
// ============================
